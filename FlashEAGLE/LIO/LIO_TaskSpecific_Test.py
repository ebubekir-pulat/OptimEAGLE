...
def main():
    ...
    for task in tasks_set:
        LIO_prompt = f"Generate optimal hyperparameters for EAGLE-3 speculative decoding with SGLANG, where the \
                ...
                --enable-ep-moe (To Select Option, Simply Write Parameter) \
                --enable-deepep-moe (To Select Option, Simply Write Parameter) \
                --enable-flashinfer-cutlass-moe (To Select Option, Simply Write Parameter) \
                --enable-flashinfer-cutedsl-moe (To Select Option, Simply Write Parameter) \
                --enable-flashinfer-trtllm-moe (To Select Option, Simply Write Parameter) \
                --enable-triton-kernel-moe (To Select Option, Simply Write Parameter) \
                --enable-flashinfer-mxfp4-moe (To Select Option, Simply Write Parameter) \
